...
void main(void) {
    ...
    MatrixKeypad_Init(&keypad2, 4, 4, rowPins, colPins, (const unsigned char*)keypadTable_2, onKeyPressed);
    
    SetCallback_MatrixKeypad(&keypad2,onKeyPressed);

    while (1) {

        MatrixKeypad_ISR(&keypad2);
    }
}
